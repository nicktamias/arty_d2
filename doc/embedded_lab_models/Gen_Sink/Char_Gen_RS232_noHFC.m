...
%      Φεβρουάριος 2015
%
%      Αρχείο Char_Gen_RS232_noHFC.m
%
%       Πρόγραμμα δημιουργίας και μετάδοσης χαρακτήρων μέσω RS232 port χωρίς έλεγχο ροής.
...
err = 0;
while cnt < Nc
   if s1.BytesToOutput <= Nbuffer-1 
            cnt = cnt + 1;          % generate new character
